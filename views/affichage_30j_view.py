...
class Recherche30jView(AbstractView):
    ...
    def make_choice(self):
        ...
        reponses['ville_depart'] = reponses['ville_depart'].upper()
        ...
        res = Recherche_disponibilite(profil,reponses['ville_depart'],reponses['date_depart']).recherche()
        if len(res) == 0 : 
            print('Pas de trajet correspondant à votre recherche')
        for trj in res :
            print(trj.__str__())
